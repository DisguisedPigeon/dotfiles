# Generated by Powerlevel10k configuration wizard on 2022-10-30 at 16:55 CET.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 64646.
# Wizard options: ascii, lean_8colors, 1 line, compact, fluent, instant_prompt=quiet.
